...
public class OkAuthPlugin: NSObject, FlutterPlugin {
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "ok_auth", binaryMessenger: registrar.messenger())
        let instance = OkAuthPlugin()
